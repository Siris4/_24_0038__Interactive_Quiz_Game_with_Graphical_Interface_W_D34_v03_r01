...
# data = str(response.json()['response_code']['results'])
data = response.json()["results"]   # We ONLY want the Value of the Key, 'results' because response code's Value is 0 only, and 'results' contains the List of data we are interested in. ["response_code"] was parallel with 'results' and is not needed. Bypass that and get the data directly from response.
# print(type(data))
# print(data)
